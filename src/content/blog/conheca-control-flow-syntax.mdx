---
heroImage: /src/assets/images/control-flow-syntax-cover.png
category: Angular
description: >-
...
Nesse artigo você vai entender da onde veio, por que existe e como essa nova sintaxe

<SButton>qwdwqdqw dqwd qdwqdw</SButton>

melhorará seus projetos Angular.

\<iframe width="560" height="315" src="https\://www\.youtube.com/embed/bP_Aqc6HQtY?si=OtCTc4kfZK2GRrzr" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen>\</iframe>
