...
category: Angular
description: >-
  Meu interesse por conhecer e aplicar a orientação a objetos (OO) cresceu consideravelmente nos últimos tempos. Esse paradigma de programação é amplamente utilizado em projetos de software e desperta a curiosidade de muitos desenvolvedores., decidi explorar a relevância da OO nos meus projetos, seja utilizando Angular, Vue.js ou React.js. Foi essa curiosidade que me motivou a criar este artigo.
pubDate: '2023-11-13'
draft: false
tags:
  - angular
